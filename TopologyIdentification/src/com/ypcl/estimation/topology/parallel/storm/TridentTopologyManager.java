...
public class TridentTopologyManager extends TopologyManager {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args == null || args.length == 0) {
			...
			t.fromFile("E:/研究生/毕业论文/code_data/ieee118es.dat");
			t.initialY();
			Topology.initialKaTable("E:/研究生/毕业论文/code_data/k2.txt");
			String conffile = "E:/研究生/毕业论文/code_data/distributed_file.txt";
			t.makeBlocksConfigure("E:/研究生/毕业论文/code_data/distributed_conf_118_1.txt", conffile);
			t.prepareBlock(conffile);
			
			//System.out.println(t.kaTable);
			if (t.execute(drpc, topologyName, 1000)) {
				t.toFile("E:/研究生/毕业论文/code_data/ieee118_output_storm_" + t.getName() + ".csv");
			} else {
