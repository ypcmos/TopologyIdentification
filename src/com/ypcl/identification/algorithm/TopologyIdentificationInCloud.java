...
public class TopologyIdentificationInCloud extends TopologyIdentification {
	private static final long serialVersionUID = 9177008602715055932L;

	public TopologyIdentificationInCloud(ITopologySimulator simulator) {
		super(simulator);
	}
	
	public TopologyIdentificationInCloud(String path) throws IOException {
		super(path);
	}
	
	public TopologyIdentificationInCloud(Graph<Integer> topology, 
	...
	public List<TopologyIdentificationInCloud> piece(int n) {
		List<TopologyIdentificationInCloud> list = new ArrayList<TopologyIdentificationInCloud>(n);
		...
		for (Graph<Integer> g : gs) {
			...
			list.add(new TopologyIdentificationInCloud(g, pDirtyBuses, pDirtyBranches, pGoodBuses));
		}
		return list;
	}
